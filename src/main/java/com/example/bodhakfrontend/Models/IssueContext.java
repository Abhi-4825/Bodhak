...
//
//    private final com.example.bodhakfrontend.IncrementalPart.model.Class.IssueType issueType;
//
...
//
//
//    public IssueContext(com.example.bodhakfrontend.IncrementalPart.model.Class.IssueType issueType, int loc, int methodCount, int outgoingDependencies, boolean hasCircularDependencies, String className, String methodName) {
