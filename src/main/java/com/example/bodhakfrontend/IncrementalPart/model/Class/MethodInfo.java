...
public class MethodInfo {
    ...
    public MethodInfo(String methodName, String returnType, List<ParameterInfo> parameters, List<MethodCallInfo> calledMethods,
                      List<com.example.bodhakfrontend.IncrementalPart.model.Class.ModifierKind> modifier, int startLine, int endLine, int startColumn, boolean isBodyEmpty, int statementCount, File sourceFile) {
