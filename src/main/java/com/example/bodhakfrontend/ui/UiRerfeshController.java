...
//    private final ProjectAnalysisResult result;
//    private  final RightPanelTabManager  rightPanelTabManager;
//    private  final AnalysisViewBuilder  analysisViewBuilder;
//
//    public UiRerfeshController(TreeView<File> treeView, FileTreeNodeFactory factory, TabPane tabPane, ProjectAnalysisResult result, RightPanelTabManager rightPanelTabManager, AnalysisViewBuilder analysisViewBuilder) {
...
//        this.analysisViewBuilder = analysisViewBuilder;
//
//    }
//
//
...
//                case REFRESH_ANALYSIS -> refreshAnalysis(path);
//
//            }
//        });
//    }
...
//
//
//    private void refreshAnalysis(Path path) {
//        rightPanelTabManager.openAnalyzeTab(()->analysisViewBuilder.build(result));
//    }
//
