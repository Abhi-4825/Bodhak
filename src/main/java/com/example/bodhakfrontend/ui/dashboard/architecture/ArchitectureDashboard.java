...
import com.example.bodhakfrontend.ui.dashboard.architecture.components.*;
...
import com.example.bodhakfrontend.ui.dashboard.common.component.DashboardHeader;
...
public class ArchitectureDashboard {
    ...
    public Node build() {
        ...
        workspaceState.setNodeSelectedListener(entity -> {
            com.example.bodhakfrontend.core.model.namespace.NamespaceInfo info = state.getNamespaceMap().get(entity);
