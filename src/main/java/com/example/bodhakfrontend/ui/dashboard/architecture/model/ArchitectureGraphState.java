...
public class ArchitectureGraphState {
    ...
    private Map<String, com.example.bodhakfrontend.core.model.namespace.NamespaceInfo> namespaceMap = new HashMap<>();
    ...
    public Map<String, com.example.bodhakfrontend.core.model.namespace.NamespaceInfo> getNamespaceMap() { return namespaceMap; }
    public void setNamespaceMap(Map<String, com.example.bodhakfrontend.core.model.namespace.NamespaceInfo> namespaceMap) { this.namespaceMap = namespaceMap; }
