...
import com.example.anuviya.analyzer.ai.evidence.builder.ScalabilityEvidenceBuilder;
import com.example.anuviya.analyzer.ai.evidence.model.scalability.ScalabilityAnalysisEvidence;
import com.example.anuviya.analyzer.ai.prompt.ScalabilityPromptBuilder;
...
public class ScalabiltyAnalysisService implements AiAnalysisService {
    ...
    public String analyze(AnalysisContext context, String model, AnalysisProgressListener eventLogger) throws Exception {
        ...
        // Open AI session
        AISession session = AIPlatform.getInstance().openSession("scalability", model);
