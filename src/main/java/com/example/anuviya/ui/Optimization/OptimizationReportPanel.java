package com.example.anuviya.ui.Optimization;
...
public class OptimizationReportPanel {
    ...
    private VBox createSuggestionCard(String title, EntityInfo clazz, CallableDeclaration method, String reason, String suggestion) {
       ...
       if(method!=null){
           Text methodName=new Text("Member: " + method.name());
       ...
       card.setOnMouseClicked(mouseEvent -> {
           if(method!=null){
               uiFeatures.openAndHighlight(method.name(), method.sourceRange().startLine(), method.sourceRange().startColumn(), clazz.getSourceFile());
           }
           else{
