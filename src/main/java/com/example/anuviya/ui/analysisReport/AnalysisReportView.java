...
import com.example.anuviya.ui.analysisReport.uiComponent.AnalysisInspectorContainer;
...
public class AnalysisReportView extends StackPane {
    ...
    private final com.example.anuviya.ui.analysisReport.compiler.CompilerExplorerDashboard compilerExplorerDashboard;
    ...
    public AnalysisReportView(AnalysisReportState state) {
        ...
        this.compilerExplorerDashboard = new com.example.anuviya.ui.analysisReport.compiler.CompilerExplorerDashboard(state);
