package com.example.anuviya.ui.nav.workspace;
...
import com.example.anuviya.ui.nav.workspace.impl.*;
...
public class WorkspaceRouter {
     ...
     */
    public WorkspaceRouter(Node overviewSplitPane, OverviewPanel overviewPanel, Runnable onToggleSidebar) {
        this.root = new StackPane();
        this.root.setStyle("-fx-background-color: #0e1415;");

        // ── Instantiate every workspace once ────────────────────────────────
        workspaces.put(NavTab.WORKSPACE,            new WorkspaceView(overviewSplitPane, overviewPanel, onToggleSidebar));
        ...
        workspaces.put(NavTab.RUNTIME_VALIDATION,   new PerformanceWorkspace());
