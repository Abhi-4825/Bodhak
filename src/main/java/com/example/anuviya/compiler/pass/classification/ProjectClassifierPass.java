package com.example.anuviya.compiler.pass.classification;
...
public class ProjectClassifierPass implements CompilerPass {
    ...
    public void execute(PipelineContext context) {
        com.example.anuviya.orchestration.progress.ProgressPublisher.publish(
            new com.example.anuviya.orchestration.progress.AnalysisProgressEvents.TechnologyDetectionStarted()
        );
