...
import com.example.anuviya.classification.classifier.CapabilityBasedClassifier;
...
import com.example.anuviya.classification.detection.FrameworkEvidence;
...
public class ProjectIntelligenceEngine {
    ...
    private FrameworkDetectionResult toFrameworkDetectionResult(DetectedTechnology tech) {
        ...
        for (String cap : tech.capabilities()) {
            try {
                builder.addCapability(com.example.anuviya.classification.Capability.valueOf(cap));
