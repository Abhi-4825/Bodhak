package com.example.bodhak.compiler.pass.entity;
...
import com.example.bodhak.ir.declaration.TypeKind;
import java.io.File;
import java.util.*;
...
public class EntityBuilderPass implements CompilerPass {
    ...
    public void execute(PipelineContext context) {
        for (CompilationUnit cu : context.getCompilationUnits()) {
            if (cu.getIntermediateRepresentation() != null) {
                ...
                String namespace = "";
                cu.getIntermediateRepresentation().accept(new EntityVisitor(cu, languageId, namespace));
            }
        }
    }
    ...
    private static class EntityVisitor implements IRVisitor {
        ...
        public EntityVisitor(CompilationUnit cu, String languageId, String initialNamespace) {
            this.cu = cu;
