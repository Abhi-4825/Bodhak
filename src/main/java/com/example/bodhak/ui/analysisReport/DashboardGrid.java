...
import com.example.bodhak.ui.analysisReport.executive.ExecutiveOverviewCard;
...
public class DashboardGrid extends VBox {
    ...
    private final java.util.function.Consumer<com.example.bodhak.ui.analysisReport.uiComponent.AnalysisInspectorContent> inspectHandler;

    // Layout elements cache
    private ExecutiveOverviewCard execBanner;
    private com.example.bodhak.ui.analysisReport.classification.ProjectClassificationCard classificationCard;
    private com.example.bodhak.ui.analysisReport.framework.FrameworkDetectionCard frameworkCard;
    private com.example.bodhak.ui.analysisReport.surface.ProjectSurfacesCard surfacesCard;
    private com.example.bodhak.ui.analysisReport.namespace.NamespaceOverviewCard namespaceCard;
    private com.example.bodhak.ui.analysisReport.reference.SemanticFlowCard semanticFlowCard;
    ...
    public DashboardGrid(AnalysisReportState state, java.util.function.Consumer<com.example.bodhak.ui.analysisReport.uiComponent.AnalysisInspectorContent> inspectHandler) {
        this.state = state;
    ...
    private void initialise() {
        ...
        classificationCard = new com.example.bodhak.ui.analysisReport.classification.ProjectClassificationCard(state.getProjectClassificationState());
        frameworkCard = new com.example.bodhak.ui.analysisReport.framework.FrameworkDetectionCard(state.getFrameworkDetectionState());
        surfacesCard = new com.example.bodhak.ui.analysisReport.surface.ProjectSurfacesCard(state.getProjectSurfacesState());
        namespaceCard = new com.example.bodhak.ui.analysisReport.namespace.NamespaceOverviewCard(state.getNamespaceOverviewState());
        semanticFlowCard = new com.example.bodhak.ui.analysisReport.reference.SemanticFlowCard(state.getSemanticFlowState());
    ...
    private void setupCardClicks() {
        setupCardClick(classificationCard, () -> new com.example.bodhak.ui.analysisReport.classification.ProjectClassificationInspector());
        setupCardClick(frameworkCard, () -> new com.example.bodhak.ui.analysisReport.framework.FrameworkInspector());
        setupCardClick(surfacesCard, () -> new com.example.bodhak.ui.analysisReport.surface.ProjectSurfacesInspector());
        setupCardClick(namespaceCard, () -> new com.example.bodhak.ui.analysisReport.namespace.NamespaceInspector());
        ...
        setupCardClick(pipelineCard, () -> new com.example.bodhak.ui.analysisReport.compiler.CompilerPipelineInspector());
    }

    private void setupCardClick(Region card, java.util.function.Supplier<com.example.bodhak.ui.analysisReport.uiComponent.AnalysisInspectorContent> inspectorSupplier) {
