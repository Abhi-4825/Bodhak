package com.example.bodhak.ui.analysisReport.executive;
...
public final class ExecutiveOverviewCard extends StackPane {
    ...
    public ExecutiveOverviewCard(ExecutiveSummaryState state) {
        this.state = state;
        initialise();
        setLayoutMode(com.example.bodhak.ui.analysisReport.DashboardGrid.LayoutMode.WIDE);
    }
     ...
     */
    public void setLayoutMode(com.example.bodhak.ui.analysisReport.DashboardGrid.LayoutMode mode) {
        getChildren().clear();

        if (mode == com.example.bodhak.ui.analysisReport.DashboardGrid.LayoutMode.WIDE) {
        ...
        } else if (mode == com.example.bodhak.ui.analysisReport.DashboardGrid.LayoutMode.MEDIUM) {
