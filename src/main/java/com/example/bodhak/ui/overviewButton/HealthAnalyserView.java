...
import com.example.bodhak.quality.fix.FixSuggestionEngine;
import com.example.bodhak.ui.WarningCard;
...
public class HealthAnalyserView {
    ...
    private final java.util.function.Supplier<AnalysisContext> contextSupplier;

    public HealthAnalyserView(Map<String, EntityViewModel> vmMap) {
        this(vmMap, () -> null);
    }

    public HealthAnalyserView(Map<String, EntityViewModel> vmMap, java.util.function.Supplier<AnalysisContext> contextSupplier) {
        this.vmMap = vmMap;
