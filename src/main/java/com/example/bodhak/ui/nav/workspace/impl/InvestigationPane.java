...
import com.example.bodhak.ui.nav.workspace.impl.DefectView.AnalysisResult;
import com.example.bodhak.ui.nav.workspace.impl.DefectView.Defect;
...
public class InvestigationPane extends ScrollPane {
    ...
    private void populateResultsView(String findings, AnalysisType type) {
        ...
        if (findings != null && findings.startsWith("Analysis failed")) {
            Label errorLabel = new Label(findings);
            errorLabel.setStyle("-fx-text-fill: #ff4b4b; -fx-font-size: 14px; -fx-font-weight: bold; -fx-padding: 10;");
