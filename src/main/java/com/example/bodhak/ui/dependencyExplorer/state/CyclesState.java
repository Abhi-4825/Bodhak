...
import com.example.bodhak.ui.dependencyExplorer.components.EntityPath;
...
import com.example.bodhak.ui.dependencyExplorer.components.PathQueryEngine;
...
public class CyclesState {
    ...
    public void update(AnalysisContext context) {
        clear();
        if (context == null || context.getDependencyGraph() == null || context.getSemanticGraphIndex() == null) {
            return;
        }
