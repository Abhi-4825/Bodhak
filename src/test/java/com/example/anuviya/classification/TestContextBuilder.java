...
public class TestContextBuilder {
    ...
    public AnalysisContext buildAnalysisContext() {
        ...
        com.example.anuviya.model.project.ProjectSnapshot snapshot =
                new com.example.anuviya.model.project.ProjectSnapshot(projectInfo, entities, Map.of());
        com.example.anuviya.classification.classifier.ProjectClassificationResult classificationResult =
                new com.example.anuviya.classification.classifier.ProjectClassificationResult(
                        Map.of(),
                        ProjectType.LIBRARY,
                        new com.example.anuviya.classification.capability.CapabilityProfile(Map.of(), 0),
                        List.of()
                );
        return new com.example.anuviya.context.DefaultAnalysisContextFactory().create(
