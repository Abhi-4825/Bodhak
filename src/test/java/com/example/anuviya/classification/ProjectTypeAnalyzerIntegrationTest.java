...
import com.example.anuviya.classification.detector.java.SpringBootDetector;
import com.example.anuviya.classification.detector.javascript.ReactDetector;
import com.example.anuviya.classification.detector.python.FastAPIDetector;
import com.example.anuviya.classification.classifier.ProjectTypeAnalyzer;
...
import static com.example.anuviya.classification.ProjectType.*;
...
class ProjectTypeAnalyzerIntegrationTest {
    ...
    void customDetector_pluggedIn_withoutModifyingExistingCode() {
        ...
        registry.register(new com.example.anuviya.classification.detection.AbstractFrameworkDetector() {
            @Override public String frameworkName() { return "ktor-test-stub"; }
            @Override public String languageId()    { return "kotlin"; }

            @Override
            protected com.example.anuviya.classification.detection.FrameworkDetectionResult doDetect(
                    com.example.anuviya.classification.detection.DetectionContext ctx) {
                return com.example.anuviya.classification.detection.FrameworkDetectionResult
