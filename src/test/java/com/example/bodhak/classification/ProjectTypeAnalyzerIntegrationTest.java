...
import com.example.bodhak.classification.detection.FrameworkDetectorRegistry;
import com.example.bodhak.classification.detector.java.SpringBootDetector;
import com.example.bodhak.classification.detector.javascript.ReactDetector;
import com.example.bodhak.classification.detector.python.FastAPIDetector;
import com.example.bodhak.classification.classifier.ProjectTypeAnalyzer;
...
class ProjectTypeAnalyzerIntegrationTest {
    ...
    void customDetector_pluggedIn_withoutModifyingExistingCode() {
        ...
        registry.register(new com.example.bodhak.classification.detection.AbstractFrameworkDetector() {
            @Override public String frameworkName() { return "ktor-test-stub"; }
            @Override public String languageId()    { return "kotlin"; }

            @Override
            protected com.example.bodhak.classification.detection.FrameworkDetectionResult doDetect(
                    DetectionContext ctx) {
                return com.example.bodhak.classification.detection.FrameworkDetectionResult
